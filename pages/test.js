  ...
  return (
    <>
      ...
      <div className="grid-layout">
        <div className="container px-4 py-32 mx-auto sm:px-8">
          <div className="grid grid-flow-row gap-4 sm:gap-6 xl:grid-flow-col xl:grid-cols-12">
            ...
            <div className="w-full h-full col-span-12 mt-2 xl:mt-0 xl:col-start-8 xl:col-end-13 ">
              <img
        ...
        <div className="px-4 py-32 sm:px-8 full-width">
          <div className="container mx-auto">
            <div className="grid grid-flow-row gap-4 sm:gap-6 xl:order-2 xl:grid-flow-col xl:grid-cols-12">
              <div className="order-2 w-full h-full col-span-12 mt-2 xl:mt-0 xl:order-1 xl:col-start-1 xl:col-end-6 ">
                <img
